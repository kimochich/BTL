<%-- 
    Document   : checkout
    Created on : Sep 7, 2019, 6:31:16 PM
    Author     : TUYENTOC
--%>
                                            ...
                                            <div class="product-container">
                                                <div class="product-list">
                                                    <div class="product-inner media align-items-center">
                                                        <div class="product-image mr-4 mr-sm-5 mr-md-4 mr-lg-5">
                                                            <a href="#">
                                                                <img src="resources/img/product/product-13.jpg" alt="Compete Track Tote" title="Compete Track Tote">
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="product-list">
                                                    <div class="product-inner media align-items-center">
                                                        <div class="product-image mr-4 mr-sm-5 mr-md-4 mr-lg-5">
                                                            <a href="#">
                                                                <img src="resources/img/product/product-4.jpg" alt="Rival Field Messenger 6" title="Rival Field Messenger 6">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
