<%-- 
    Document   : footer
    Created on : Sep 7, 2019, 1:54:31 PM
    Author     : TUYENTOC
--%>
                        ...
                        <div class="footer-single-widget">
                            <div class="widget-title">
                                <div class="footer-logo mb-30">
                                    <a href="index.jsp">
                                         <img src="resources/img/logo/logo-sinrato.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="widget-body">
                                ...
                                <div class="payment-method">
                                    <h4>payment</h4>
                                    <img src="resources/img/payment/payment.png" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-bottom-content">
                            ...
                            <p>Copyright © 2018 <a href="#">sinratos</a>. All Right Reserved</p>
                            </div>
